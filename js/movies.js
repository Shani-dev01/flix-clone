...
$(document).ready(async function () {
    ...
    async function fetchMovieWithVideo(movieIndex) {
        try {
            const posterUrl = `${url}/movie/top_rated?api_key=${api_key}`;
    ...
    if (heroMovie) {
        ...
        $(document).on('click', '.movies-page-play-button', function () {
            window.location.href = '../html/watch.html';
        });

        console.log(heroMovie)
        const name = heroMovie.title || heroMovie.name;
        // Banner HTML
        ...
        <div class="child-hero-div" >
            <div class="title-div">
                ...
                <div class="btnDivs">
                    <button class="movies-page-play-button" >
